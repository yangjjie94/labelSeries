...
from libs.lib import distance, distancetoline, distancetopoint
import sys
import copy
import math
...
class Ellipse(Shape):
    ...
    def updateCenter(self, eps=1e-3):
        if len(self.points) != 4:
            return None
